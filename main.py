...
directory = "avionics/"
list_filename = "avionics_gps_material.txt"
code_filename = directory + "code_" + list_filename


with open(directory + list_filename) as f:
    items = f.read().split("\n")
...
with open(code_filename, "w") as file:
    ...
    file.write("    \end{minipage}% \n")
    file.write("\\vspace{-1.5pt}\n")
    file.write("\\begin{minipage}{0.91\paperwidth}\n")
    file.write("\\begin{tabular}{ |m{0.05\paperwidth} m{0.71\paperwidth}|m{0.015\paperwidth}| } \n")
